        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="mailto:hello@wingsofchange.com" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <a href="mailto:hello@wingsofchange.com" className="hover:text-white transition-colors">
                  hello@wingsofchange.com
                </a>
              </li>
              <li>
