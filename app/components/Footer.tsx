        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <a href="mailto:wingsofchangeghana@gmail.com" className="text-gray-400 hover:text-white transition-colors">
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                          ...
                          <a href="tel:+233556090269" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>
                              <a href="tel:+233556090269" className="hover:text-white transition-colors">
              +233 55 609 0269
              </a>
              </li>
              <li>
